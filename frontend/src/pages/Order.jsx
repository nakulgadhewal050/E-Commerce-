...
function Order() {
  ...
  return (
    <div className='w-[100vw] min-h-[100vh] pb-[150px] overflow-hidden bg-gradient-to-l from-[#141414] to-[#0c2025] '>
      <div className='h-[18%] w-[100%] text-center mt-[80px]'>
              ...
              <div className='w-[100%] h-[80%] flex items-start gap-6 bg-[#51808048] py-[10px] px-[20px] rounded-2xl relative'>
                ...
                <div className='flex flex-col items-start justify-center gap-[5px]'>
                  ...
                  <div className='absolute md:right-[5%] right-[2%] md:top-[40%]  top-[65%]'>
                     <button className='px-[15px] py-[7px] rounded-md bg-[#101919] text-[#f3f9fc] text-[12px]
                         md:text-[16px] cursor-pointer active:bg-slate-500 ' onClick={loadOrderData}>
                           Track Order
                     </button>
                  </div>
